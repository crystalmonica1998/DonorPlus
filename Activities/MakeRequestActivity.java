...
public class MakeRequestActivity extends AppCompatActivity {
    ...
    private void pickImage(){
        ...
        startActivityForResult(intent, 101);//pick from gallery
    }
    ...
    private void uploadRequest(String message){
        ...
        String number = PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getString("number","12345678");
